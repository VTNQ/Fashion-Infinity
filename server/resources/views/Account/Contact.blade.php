                            ...
                            <table role="presentation" style="width:100%;border-collapse:collapse;border:0;border-spacing:0;">
                                <tr>
                                    <td style="padding:0 0 36px 0;color:#153643;">
                                        <p style="font-weight:bold;margin:0 0 20px 0;font-family:Arial,sans-serif;text-align: center;font-size: 28px;">
                                           Contact</h1>
                                        <p style="margin: 0 0 12px 0; font-size: 14px; line-height: 42px;  font-family: Arial,sans-serif;  text-align: center;">
                                           Name:<strong>{{$user ? $user['name']: ''}}</strong> 
                                        </p>

                                        <p style="margin: 10px 0 12px 0;font-size: 14px;line-height: 24px;font-family: Arial,sans-serif;text-align: center;">
                                        Subject:<strong>{{$user ? $user['Subject']:''}}</strong> 
                                        </p>
                                        <p style="margin: 10px 0 12px 0;font-size: 14px;line-height: 24px;font-family: Arial,sans-serif;text-align: center;">
                                        Message: <strong> {{$user ? $user['Message']:''}}</strong>
                                        </p>
