...
class DetailController extends Controller
{
   public function getDetail($ID){
    ...
    join("category","category.ID","=","category_product.id_Category")->join("picture","picture.ID","=","category_product.id_Picture")-> join("detail_warehouse","detail_warehouse.ID_Product","=","product.ID")
    ->select([
