...
<div className="bg-pink-600 w-full h-[500px]">
	<h1 className="text-black">hello</h1>

</div>
	
<section id="menu" class="clearfix cd-secondary-nav mb-[10%]">
...
<section id="footer">
  <div class="container ">
    <div class="row">
      ...
      <div class="footer_1 mgt clearfix col-md-3">
        <div class="footer_1i clearfix">
          <h4 class="mgt col_2">Our Story</h4>
      ...
      <div class="footer_1 mgt clearfix col-md-3">
        <div class="footer_1i clearfix">
          <h4 class="mgt col_2">Our Collections</h4>
      ...
      <div class="footer_1 mgt clearfix col-md-3">
        <div class="footer_1i clearfix">
          <h4 class="mgt col_2">Our Categories</h4>
      ...
      <div class="footer_1 mgt clearfix col-md-3">
        <div class="footer_1i clearfix">
          <h4 class="mgt col_2">Join Our Newsletter</h4>
      ...
      <div class="footer_1 mgt clearfix col-md-3">
        <div class="footer_1i clearfix">
          <h4 class="mgt col_2">Our Properties</h4>
      ...
      <div class="footer_1 mgt clearfix col-md-3">
        <div class="footer_1i clearfix">
          <h4 class="mgt col_2">Advertisement</h4>
      ...
      <div class="footer_1 mgt clearfix col-md-3">
        <div class="footer_1i clearfix">
          <h4 class="mgt col_2">Follow Us</h4>
      ...
      <div class="footer_1 mgt clearfix col-md-3">
        <div class="footer_1i clearfix">
          <h4 class="mgt col_2">Social Links</h4>
