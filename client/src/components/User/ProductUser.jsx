...
function ProductUser(){
	...
	const[selectedSortOption,setSelectedSortOptions]=useState("Alphabetically, A-Z");
    ...
    const currentCategories = sortedProducts.slice(indexOfFirtCategory, indexOflastCategory)
    return(
...
<div class="container">
 <div class="row">
	  ...
	  <div class="product_1r clearfix" >
	   ...
	   <div class="col-sm-6">
	    <div class="center_product_1r2r text-right clearfix">
		 ...
		 <select class="form-control" id="subject" value={selectedSortOption} onChange={(e)=>setSelectedSortOptions(e.target.value)} name="subject">
  ...
  // Add product ID to the set outside JSX expression
	  ...
	  <div class="col-sm-12">
	   <ul>
	    <li><a className='cursor-pointer' onClick={()=>setCurrentPage((prev)=>Math.max(prev-1,0))}><i class="fa fa-chevron-left"></i></a></li>
   ...
   <div class="footer_b clearfix">
	 ...
	 <div class="col-sm-7 space_left">
	  <div class="footer_bl  text-right clearfix">
	   <p>© 2013 Your Website . All Rights Reserved | Design by <a class="col_1" href="http://www.templateonweb.com">TemplateOnWeb</a></p>
	  </div>
	 </div>
   </div>
  </div>
